class Report {
  ...
  final String? resolutionProofPhotoUrl;
  ...
  factory Report.fromJson(Map<String, dynamic> json) {
    return Report(
      ...
      resolutionProofPhotoUrl: json['resolution_proof_photo_url'] as String?,
  ...
  Report copyWith({int? upvoteCount, int? commentCount, bool? hasUpvoted}) {
    return Report(
      ...
      resolutionProofPhotoUrl: resolutionProofPhotoUrl,
